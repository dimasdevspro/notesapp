  ...
  export function NewNoteCard( {onNoteCreated}: NewNoteCardProps){
      ...
      return (
        ...
        <p className="text-sm loading-6 text-slate-400">Grave uma nota em áudio que será convertida para texto automaticamente.</p>
        </Dialog.Trigger>
        <Dialog.Portal>
      ...
      <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
        ...
        <form className="flex-1 flex flex-col " >
          ...
          {shouldShowOnboarding ? (
            <p className="text-sm loading-6 text-slate-400">
            ...
            <textarea 
            autoFocus
            className="text-sm loading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none"
